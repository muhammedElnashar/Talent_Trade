                            ...
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush rounded-3">
                                    <div class="row mt-2 p-3">
                                        <p class="fw-bold col-12 "><i class="fa-solid fa-address-card me-1"></i>About Me :
                                        </p>
                                    ...
                                    <li class="list-group-item d-flex  align-items-center p-3">
                                        ...
                                        <a class="fs-5  mb-3 ms-2 text-dark"
                                            href="{{asset('images/users/' . $candidate->cv)}}" target="_blank"> CV </a>
                                    </li>
                                        ...
                                        <div class="row ms-5 ">
                                            ...
                                            @foreach ($candidate->technology as $can)
                                                                                <h1 class="col-2 badge rounded-pill bg-primary mx-2 p-2 fs-6 d-flex ">
                                                                                    ...
                                                                                    @endphp
                                                                                    <form action="{{route("candidate-technology.destroy", $candTec->id)}}"
                                    ...
                                    <div class="card mb-4 mb-md-0">
                                        <div class="card-body">
                                            <form action="{{route("candidate-technology.store")}}" method="post">
                                                @csrf
                                                <p class="mb-4 fw-bold">Add Skill
                                                </p>
                                                ...
                                                @enderror
                                                <button type="submit" class="btn btn-primary px-5 mt-3 fw-bold">Add</button>
                                            </form>
